...
title: "Cuando el suelo se afloja: pensar la angustia"
author: Diego Moreno
description: "Un ensayo sobre esa sensación de fondo en la que la vida no se rompe pero tampoco se sostiene del todo — y la idea de que existir es, en gran medida, resistir."
image:
  src: "/src/assets/image/blog/blog-post-2.jpg"
...
## El problema no es la angustia — es qué hacemos con ella
...
- Alguien que, frente a una pérdida, escucha rápidamente *"esto se supera"* o *"tienes que ser fuerte"*.
- Alguien que recibe una etiqueta diagnóstica que ordena lo que le pasa, pero no alcanza a tocar lo que duele.
- Alguien que ha aprendido a gestionarse tan bien que ya no sabe qué hacer cuando su malestar **no se deja gestionar**.

En todos esos casos, la angustia no es acogida: es neutralizada o devuelta al individuo como si fuera un fallo propio.

---

## La terapia como lugar donde permanecer
